...
public class ModBlocks {
    ...
    // copper slabs
    public static BlockAndBlockItem VERTICAL_CUT_COPPER_SLAB = VerticalSlabTypes.copperSlab("vertical_cut_copper_slab", OxidationLevel.UNAFFECTED);
    public static BlockAndBlockItem VERTICAL_EXPOSED_CUT_COPPER_SLAB = VerticalSlabTypes.copperSlab("vertical_exposed_cut_copper_slab", OxidationLevel.EXPOSED);
    public static BlockAndBlockItem VERTICAL_WEATHERED_CUT_COPPER_SLAB = VerticalSlabTypes.copperSlab("vertical_weathered_cut_copper_slab", OxidationLevel.WEATHERED);
    public static BlockAndBlockItem VERTICAL_OXIDIZED_CUT_COPPER_SLAB = VerticalSlabTypes.copperSlab("vertical_oxidized_cut_copper_slab", OxidationLevel.OXIDIZED);

    public static BlockAndBlockItem VERTICAL_WAXED_CUT_COPPER_SLAB = VerticalSlabTypes.copperSlab("vertical_waxed_cut_copper_slab", OxidationLevel.UNAFFECTED);
    public static BlockAndBlockItem VERTICAL_WAXED_EXPOSED_CUT_COPPER_SLAB = VerticalSlabTypes.copperSlab("vertical_waxed_exposed_cut_copper_slab", OxidationLevel.EXPOSED);
    public static BlockAndBlockItem VERTICAL_WAXED_WEATHERED_CUT_COPPER_SLAB = VerticalSlabTypes.copperSlab("vertical_waxed_weathered_cut_copper_slab", OxidationLevel.WEATHERED);
    public static BlockAndBlockItem VERTICAL_WAXED_OXIDIZED_CUT_COPPER_SLAB = VerticalSlabTypes.copperSlab("vertical_waxed_oxidized_cut_copper_slab", OxidationLevel.OXIDIZED);
