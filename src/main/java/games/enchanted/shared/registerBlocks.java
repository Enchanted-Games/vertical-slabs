...
public class registerBlocks {
    ...
    public static Block registerVerticalStoneSlab(String id) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(VerticalSlabs.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_STONE_PLACE));
    }
    public static Block registerVerticalNetherBrickSlab(String id) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(VerticalSlabs.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_NETHER_BRICKS_PLACE));
    }
    public static Block registerVerticalDeepslateSlab(String id) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(VerticalSlabs.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_DEEPSLATE_PLACE));
    }
    public static Block registerVerticalDeepslateBrickSlab(String id) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(VerticalSlabs.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_DEEPSLATE_BRICKS_PLACE));
    }
    public static Block registerVerticalDeepslateTileSlab(String id) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(VerticalSlabs.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_DEEPSLATE_TILES_PLACE));
    }
    ...
    public static Block registerVerticalCopperSlab(String id, OxidationLevel oxidationLevel) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(VerticalSlabs.MOD_ID, id), new OxidizableVerticalSlab(oxidationLevel , settings, SoundEvents.BLOCK_COPPER_PLACE));
    }
    public static Block registerVerticalMudSlab(String id) {
        try {
            ...
            return Registry.register(Registries.BLOCK, new Identifier(VerticalSlabs.MOD_ID, id), new CombinableVerticalSlabBlock(settings, SoundEvents.BLOCK_MUD_BRICKS_PLACE));
        } catch (Exception e) {
            return null;
        }
    }
