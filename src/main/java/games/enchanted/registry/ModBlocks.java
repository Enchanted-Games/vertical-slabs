...
import games.enchanted.registry.types.TestType;
...
public class ModBlocks{
    // wood slabs
    public static final Block VERTICAL_OAK_SLAB = registertest("vertical_oak_slab");
    ...
    public static final Block TEST_BLOCKSTATE = registertest("test_blockstate");
    public static Block registertest(String id) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(VerticalSlabs.MOD_ID, id), new TestType(settings));
    }
